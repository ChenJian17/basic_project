...
public final class ProjectConstant {
    public static final String BASE_PACKAGE = "com.crc.mq";//生成代码所在的基础包名称，可根据自己公司的项目修改（注意：这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类）
  ...
  //TODO addby sqy 20190425
    public static final String CORE_BASE_PACKAGE = "com.crc.mq";
    public static final String MAPPER_INTERFACE_REFERENCE = CORE_BASE_PACKAGE + ".core.Mapper";//Mapper插件基础接口的完全限定名
